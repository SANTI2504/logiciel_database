!function (o, t, r) {
    ...
    var l = r("body"), d = r(o), u = r('div[data-menu="menu-wrapper"]').html(),
    ...
    r.app.menu = {
        ...
        is_touch_device: function () {
            ...
            var a, n = ["(", e.join("touch-enabled),("), "heartz", ")"].join("");
            return a = n, o.matchMedia(a).matches
        },
        manualScroller: {
            obj: null, init: function () {
                r(".app-sidebar").hasClass("menu-dark");
                r.app.menu.is_touch_device() ? r(".app-sidebar").addClass("menu-native-scroll") : this.obj = new PerfectScrollbar(".main-menu-content", {
                    suppressScrollX: !0,
                    wheelPropagation: !1
                })
            }, update: function () {
                if (this.obj) {
                    if (!0 === r(".app-sidebar").data("scroll-to-active")) {
                        var e, a, n;
                        if (e = t.querySelector(".main-menu-content li.active"), a = t.querySelector(".main-menu-content"), l.hasClass("nav-collapsed") && r(".main-menu-content li.sidebar-group-active").length && (e = t.querySelector(".main-menu-content li.sidebar-group-active")), e && (n = e.getBoundingClientRect().top + a.scrollTop), n > parseInt(2 * a.clientHeight / 3)) var s = n - a.scrollTop - parseInt(a.clientHeight / 2);
                        setTimeout(function () {
                ...
                "vertical-menu" != l.data("menu") && "vertical-overlay-menu" != l.data("menu") || !r(".app-sidebar").hasClass("menu-fixed") || (r(".main-menu-content").css("height", r(o).height() - r(".header-navbar").height() - r(".main-menu-header").outerHeight() - r(".main-menu-footer").outerHeight()), this.update())
            }
        },
        init: function (e) {
        ...
        change: function (e) {
            ...
            "vertical-menu" === n && this.toOverlayMenu(a.name, n), l.is(".horizontal-layout") && !l.hasClass(".horizontal-menu-demo") && (this.changeMenu(a.name), r(".nav-toggle").removeClass("is-active")), "horizontal-menu" != n && this.drillDownMenu(a.name), "xl" == a.name && (r('body[data-open="hover"] .dropdown').on("mouseenter", function () {
            ...
            })), r(".header-navbar").hasClass("navbar-brand-center") && r(".header-navbar").attr("data-nav", "brand-center"), "sm" == a.name || "xs" == a.name ? r(".header-navbar[data-nav=brand-center]").removeClass("navbar-brand-center") : r(".header-navbar[data-nav=brand-center]").addClass("navbar-brand-center"), "xl" !== a.name && "horizontal-menu" == n && r("#navbar-type").toggleClass("d-none d-xl-block"), r("ul.dropdown-menu [data-toggle=dropdown]").on("click", function (e) {
            ...
            }), "horizontal-menu" == n && r("li.dropdown-submenu").on("mouseenter", function () {
                r(this).parent(".dropdown").hasClass("show") || r(this).removeClass("openLeft");
                var e = r(this).find(".dropdown-menu");
                if (e) {
                    var a = r(o).height(), n = e.offset().top, s = e.offset().left, t = e.width();
        ...
        transit: function (e, a) {
            var n = this;
            l.addClass("changing-menu"), e.call(n), l.hasClass("vertical-layout") && (l.hasClass("menu-open") || l.hasClass("menu-expanded") ? (r(".nav-toggle").addClass("is-active"), "vertical-menu" === l.data("menu") && r(".main-menu-header") && r(".main-menu-header").show()) : (r(".nav-toggle").removeClass("is-active"), "vertical-menu" === l.data("menu") && r(".main-menu-header") && r(".main-menu-header").hide())), setTimeout(function () {
                a.call(n), l.removeClass("changing-menu"), n.update()
            }, 500)
        },
        open: function () {
            this.transit(function () {
                l.removeClass("menu-hide nav-collapsed").addClass("menu-open"), this.hidden = !1, this.expanded = !0, l.hasClass("vertical-overlay-menu") && (r(".sidenav-overlay").removeClass("d-none").addClass("d-block"), r("body").css("overflow", "hidden"))
            }, function () {
                !r(".app-sidebar").hasClass("menu-native-scroll") && r(".app-sidebar").hasClass("menu-fixed") && (this.manualScroller.enable(), r(".main-menu-content").css("height", r(o).height() - r(".header-navbar").height() - r(".main-menu-header").outerHeight() - r(".main-menu-footer").outerHeight())), l.hasClass("vertical-overlay-menu") || (r(".sidenav-overlay").removeClass("d-block d-none"), r("body").css("overflow", "auto"))
            })
        },
        hide: function () {
            this.transit(function () {
                ...
                !r(".app-sidebar").hasClass("menu-native-scroll") && r(".app-sidebar").hasClass("menu-fixed") && this.manualScroller.enable(), l.hasClass("vertical-overlay-menu") || (r(".sidenav-overlay").removeClass("d-block d-none"), r("body").css("overflow", "auto"))
            })
        },
        expand: function () {
            !1 === this.expanded && ("vertical-menu" == l.data("menu") && r(".nav-toggle").find(".toggle-icon").removeClass("ft-toggle-left").addClass("ft-toggle-right"), this.transit(function () {
        ...
        toggle: function () {
            var e = Unison.fetch.now(), a = (this.collapsed, this.expanded), n = this.hidden, s = l.data("menu");
            switch (e.name) {
                case"xl":
                    !0 === a ? "vertical-overlay-menu" == s ? this.hide() : this.collapse() : "vertical-overlay-menu" == s ? this.open() : this.expand();
                    break;
                case"lg":
                    !0 === a ? "vertical-overlay-menu" == s || "vertical-menu" == s || "horizontal-menu" == s ? this.hide() : this.open() : "vertical-overlay-menu" == s || "vertical-menu" == s || "horizontal-menu" == s ? this.open() : this.hide();
                    break;
                case"md":
                case"sm":
                case"xs":
        ...
        bind_events: function () {
            ...
            r(".navigation-main").on("mouseenter.app.menu", "li", function () {
                ...
                if (r(".hover", ".navigation-main").removeClass("hover"), l.hasClass("nav-collapsed") && "vertical-menu" != l.data("menu")) {
                    ...
                    var a, n, s, t = e.find("span.menu-title").clone();
                    if (e.hasClass("has-sub") || (a = e.find("span.menu-title").text(), n = e.children("a").attr("href"), "" !== a && ((t = r("<a>")).attr("href", n), t.attr("title", a), t.text(a), t.addClass("menu-title"))), s = e.css("border-top") ? e.position().top + parseInt(e.css("border-top"), 10) : e.position().top, "vertical-compact-menu" !== l.data("menu") && t.appendTo(".main-menu-content").css({
                        position: "fixed",
                        top: s
                ...
                var a = r(this);
                a.is(".disabled") ? e.preventDefault() : l.hasClass("nav-collapsed") && "vertical-menu" != l.data("menu") ? e.preventDefault() : a.has("ul").length ? a.is(".open") ? a.trigger("close.app.menu") : a.trigger("open.app.menu") : a.is(".active") || (a.siblings(".active").trigger("deactive.app.menu"), a.trigger("active.app.menu")), e.stopPropagation()
            }), r(".app-sidebar").on("mouseenter", function () {
                if ("vertical-menu" == l.data("menu") && (r(".app-sidebar, .navbar-header").addClass("expanded"), l.hasClass("nav-collapsed"))) {
                    ...
                    e.children("ul").hide().slideDown(200, function () {
                        r(this).css("display", "")
                    }), e.addClass("open").removeClass("nav-collapsed-open"), r(".main-menu-content").find("li.active").parents("li").addClass("open")
                }
            }).on("mouseleave", function () {
                l.hasClass("nav-collapsed") && "vertical-menu" == l.data("menu") && setTimeout(function () {
                    if (0 === r(".app-sidebar:hover").length && 0 === r(".navbar-header:hover").length && (r(".app-sidebar, .navbar-header").removeClass("expanded"), l.hasClass("nav-collapsed"))) {
                        var e = r(".app-sidebar li.open"), a = e.children("ul");
                        e.addClass("nav-collapsed-open"), a.show().slideUp(200, function () {
                            r(this).css("display", "")
                        }), e.removeClass("open")
                    }
                }, 1)
            }), r(".main-menu-content").on("mouseleave", function () {
                l.hasClass("nav-collapsed") && (r(".main-menu-content").children("span.menu-title").remove(), r(".main-menu-content").children("a.menu-title").remove(), r(".main-menu-content").children("ul.menu-content").remove()), r(".hover", ".navigation-main").removeClass("hover")
            }), r(".navigation-main li.has-sub > a").on("click", function (e) {
                e.preventDefault()
            }), r("ul.menu-content").on("click", "li", function (e) {
                var a = r(this);
                if (a.is(".disabled")) e.preventDefault(); else if (a.has("ul")) if (a.is(".open")) a.removeClass("open"), i.collapse(a); else {
                    if (a.addClass("open"), i.expand(a), r(".app-sidebar").hasClass("menu-collapsible")) return !1;
                    a.siblings(".open").find("li.open").trigger("close.app.menu"), a.siblings(".open").trigger("close.app.menu"), e.stopPropagation()
        ...
        adjustSubmenu: function (e) {
            var a, n, s, t, i, o = e.children("ul:first"), l = o.clone(!0);
            r(".main-menu-header").height(), a = e.position().top, s = d.height() - r(".header-navbar").height(), i = 0, o.height(), 0 < parseInt(e.css("border-top"), 10) && (i = parseInt(e.css("border-top"), 10)), t = s - a - e.height() - 30, r(".app-sidebar").hasClass("menu-dark"), n = a + e.height() + i, l.addClass("menu-popout").appendTo(".main-menu-content").css({
                top: n,
                position: "fixed",
                "max-height": t
            })
        ...
        collapse: function (e, a) {
            var n = e.children("ul");
            e.addClass("changing"), n.show().slideUp(r.app.nav.config.speed, function () {
        ...
        expand: function (e, a) {
            var n = e.children("ul"), s = n.children("li").addClass("is-hidden");
