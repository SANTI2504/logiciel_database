                ...
                <div class="col col-12">
                    <div class="card-body ">
                        ...
                        <form method="POST" action="{{url('usuarios/especialistas/'. $specialist -> id)}}">
                            ...
                            <div class="form-row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <input id="name" type="text" name="name"  required autofocus autocomplete="name" class="form-control mb-2" placeholder="ej: Camilo Andres" value="{{$specialist ->name}}" >
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-2">
                                        <label for="basic-form-2">Apellidos</label>
                                        <input id="lastnames" type="text" name="lastnames"  required autocomplete="lastnames" class="form-control mb-2" placeholder="ej: Mesa Rincon" value="{{$specialist ->lastnames}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <input id="email" type="email" name="email" value="{{$specialist -> email}}" required class="form-control mb-2" placeholder="ej: camilo@gmail.com">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-2">
                                        <label for="basic-form-4">Numero de contacto</label>
                                        <input id="number_cell" type="text" name="number_cell" value="{{$specialist -> number_cell}}" required class="form-control mb-2" placeholder="ej: 3115676507">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <select class="select2 form-control mb-2" name="type_document_id" id="type_document_id">
                                            <option value="{{$specialist -> type_document ->id}}">{{$specialist -> type_document->name}}</option>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <input id="number_document" type="text" name="number_document" value="{{$specialist -> number_document}}" required class="form-control mb-2" placeholder="ej: 1023659635">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <input id="date_of_bird" type="date" name="date_of_bird" value="{{ $specialist -> date_of_bird }}" required class="form-control mb-2">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <select class="select2 form-control mb-2" name="eps_id" id="eps_id">
                                            <option value="{{$specialist -> eps -> id}}">{{$specialist -> eps -> name}}</option>
                                            <!--usamos los datos de la tabla type_documents-->
                            ...
                            <button type="submit" id="type-success" class="btn bg-light-primary mr-1 mb-1 mb-sm-0 form-editar"><i class="ft-check-square mr-1"></i>Guardar</button>
