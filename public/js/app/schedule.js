...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventSources:{
            url: baseURL+"/calendario/citas/mostrar",
            method: "POST",
            extraParams:{
        ...
        eventClick:function (info){
            ...
            axios.post(baseURL+"/calendario/citas/editar/"+info.event.id).
            then(
                (respuesta)=>{
                    //muestra solo el id
    ...
    document.getElementById("btnGuardar").addEventListener("click", function () {
        Swal.fire({
            ...
            if (result.value) {
                enviarDatos("/calendario/citas/agregar");
            }
        })
    ...
    document.getElementById("btnEliminar").addEventListener("click", function (){
        Swal.fire({
            ...
            if (result.value) {
                enviarDatos("/calendario/citas/borrar/"+formulario.id.value);
    ...
    document.getElementById("btnModificar").addEventListener("click", function (){
        Swal.fire({
            ...
            if (result.value){
                enviarDatos("/calendario/citas/actualizar/"+formulario.id.value);
            }
        })
