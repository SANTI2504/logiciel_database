                        ...
                        <div class="card-body ">
                            <form method="POST" novalidate action="{{url('usuarios/pacientes')}}">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-2">
                                            ...
                                            <input id="name" type="text" name="name" value="{{ old('name') }}" autofocus
                                                   ...
                                                   data-validation-required-message="este dato es requerido">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-2">
                                            ...
                                            <input id="email" type="email" name="email" value="{{ old('email') }}"
                                                   class="form-control mb-2" placeholder="ej: camilo@gmail.com" required
                                                   data-validation-required-message="este dato es requerido">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                ...
                                <div class="form-group mb-2" hidden>
                                    ...
                                    <select class="select form-control mb-2" name="roles_id" id="roles_id">
