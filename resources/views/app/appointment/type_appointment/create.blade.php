    ...
    <div class="main-content">
        ...
        <div class="content-wrapper">
            <section class="users-list-wrapper">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="content-header">Crear nuevo tipo de cita</div>
                ...
                <div class="col col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{url('citas/tipo-cita')}}" method="POST">
                                    @csrf
                                    <div class="form-row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">
                                                <label for="basic-form-1">Nombre del tipo de cita</label>
                                                <input type="text" id="quanti" name="name" class="form-control"
                                                       placeholder="Ej: Optometria" required>
                                            </div>
                                        </div>
                                    </div>
