...
<head>
    ...
    <title>Basic Cards - Apex responsive bootstrap 4 admin template</title>
            ...
            <div class="nav-container">
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="has-sub nav-item"><a href="javascript:;"><i class="ft-layers"></i><span class="menu-title" data-i18n="Cards">Cards</span></a>
                        <ul class="menu-content">
                            <li class="active"><a href="cards-basic.html"><i class="ft-arrow-right submenu-icon"></i><span class="menu-item" data-i18n="Basic Cards">Basic Cards</span></a>
                            </li>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="media">
                                            ...
                                            <div class="media-right align-self-center">
                                                <i class="ft-book-open primary font-large-2 float-right"></i>
                                            </div>
                                        </div>
                                        <div class="progress" style="height: 4px;">
                                            <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="80" aria-valuemin="80" aria-valuemax="100" style="width:80%"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="media">
                                            ...
                                            <div class="media-right align-self-center">
                                                <i class="ft-message-square warning font-large-2 float-right"></i>
                                            </div>
                                        </div>
                                        <div class="progress" style="height: 4px;">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="media">
                                            ...
                                            <div class="media-right align-self-center">
                                                <i class="ft-map-pin danger font-large-2 float-right"></i>
                                            </div>
                                        </div>
                                        <div class="progress" style="height: 4px;">
                            ...
                            <div class="card card-inverse bg-warning">
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-left align-self-center">
                                                <i class="ft-map-pin font-large-2 float-left"></i>
                                            </div>
                                            <div class="media-body text-right">
                                                <h3 class="card-text">423</h3>
                                                <span>Total Visits</span>
                ...
                <section id="basic-examples">
                    <div class="row">
                        <div class="col-12 mb-1">
                            ...
                            <p class="content-sub-header mb-1">Cards require a small amount of markup and classes to provide you with as much control as possible. These classes and markup are flexible though and can typically be remixed and extended with ease. For example, if your card has no flush content like images, feel free to put the <code>.card-body</code> class on the <code>.card</code> element to consolidate your markup.</p>
                        </div>
                    </div>
                    ...
                    <div class="row match-height">
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button type="button" class="btn btn-warning">Go somewhere</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-12">
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body">
                                        <img class="card-img img-fluid rounded mb-3" src="../app-assets/img/photos/08.jpg" alt="Card image cap">
                                        <h4 class="card-title">Card title</h4>
                                        <p class="card-text">Sweet halvah dragée jelly-o halvah carrot cake oat cake. Donut jujubes jelly chocolate cake marzipan chocolate chocolate bar.</p>
                                        <button type="button" class="btn btn-success">Go somewhere</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-12">
                            <div class="card">
                                <div class="card-header pb-3">
                                    <h4 class="card-title">Card title</h4>
                                    <h6 class="card-subtitle text-muted mb-0">Support card subtitle</h6>
                                </div>
                                <div class="card-content">
                                    ...
                                    <div class="card-footer pt-0">
                                        <a class="card-link danger" href="javascript:;">Card link</a>
                                        <a class="card-link danger" href="javascript:;">Another link</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-12">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text mt-2">Topping dessert marshmallow gummi bears chupa chups marzipan.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer pt-0">
                                    <a class="card-link info darken-2" href="javascript:;">Card link</a>
                                    <a class="card-link info darken-2" href="javascript:;">Another link</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="content-types">
                    <div class="row">
                        <div class="col-12 mb-1">
                            ...
                            <p class="content-sub-header mb-1">Cards support a wide variety of content, including images, text, list groups, links, and more. Mix and match multiple content types to create the card you need.</p>
                        </div>
                    </div>
                    ...
                    <div class="row match-height">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-footer pt-0">
                                    <a class="card-link success" href="javascript:;">Card link</a>
                                    <a class="card-link success" href="javascript:;">Another link</a>
                                </div>
                            </div>
                        </div>
                ...
                <section id="sizing">
                    <div class="row match-height">
                        <div class="col-12 mb-1">
                            ...
                            <p class="content-sub-header mb-1">Constrain the width of cards via custom CSS, our predefined grid classes, or with custom styles using our grid mixins.</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <form class="form">
                                            <div class="form-body">
                                                <h6 class="mt-3"><i class="ft-user mr-2"></i>Personal Info</h6>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                ...
                                                <h6 class="mt-2"><i class="ft-check-circle mr-2"></i>Requirements</h6>
                                                <div class="form-group">
                                            ...
                                            <div>
                                                <button type="button" class="btn btn-primary mr-1"><i class="ft-check mr-2"></i>Save</button>
                                                <button type="button" class="btn btn-secondary"><i class="ft-x mr-2"></i>Cancel</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="form">
                                            <div class="form-body">
                                                ...
                                                <h6 class="mt-2"><i class="ft-mail mr-2"></i>Contact Info & Bio</h6>
                                                <div class="form-group">
                ...
                <section id="text-alignment">
                    <div class="row">
                        <div class="col-12 mb-1">
                            ...
                            <p class="content-sub-header mb-1">You can quickly change the text alignment of any card—in its entirety or specific parts—with our text align classes.</p>
                        </div>
                    </div>
                ...
                <section id="header-footer">
                    <div class="row">
                        <div class="col-12 mb-1">
                            ...
                            <p class="content-sub-header mb-1">Add an optional header and/or footer within a card.</p>
                        </div>
                    </div>
                    <div class="row match-height">
                        <div class="col-lg-4 col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p>Basic Card With Header & Footer</p>
                                </div>
                                <div class="card-content">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p>Floating Action Button Card With Header & Footer</p>
                                </div>
                                <div class="card-content">
                                    <div class="card-img">
                                        <img class="img-fluid" src="../app-assets/img/photos/07.jpg" alt="Card image cap">
                                        <a class="btn btn-floating halfway-fab btn-large bg-danger"><i class="ft-plus"></i></a>
                                    </div>
                                    <div class="card-body">
                                        <p class="card-text">Bear claw sesame snaps gummies chocolate.</p>
                                        <a class="card-link danger" href="javascript:;">Card link</a>
                                        <a class="card-link danger" href="javascript:;">Another link</a>
                                    </div>
                                </div>
                                <div class="card-footer text-muted pt-0">
                                    <span class="float-left">1 day ago</span>
                                    <span class="tags float-right">
            <span class="badge bg-success mb-1">Technology</span>
            <span class="badge bg-warning">Gaming</span>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Carousel</h4>
                                    <p>Carousel Card With Header & Footer</p>
                                </div>
                                <div class="card-content">
...
<div class="buy-now"><!-- Buy now button -->
