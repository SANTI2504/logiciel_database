...
@section('content')
    ...
    <div class="main-content">
        ...
        <div class="content-wrapper"><section class="users-list-wrapper">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="breadcrumb-item" itemscope itemprop="itemListElement" itemtype="http://schema.org/ListItem">
                            ...
                            <span itemprop="name">Horas disponibles</span>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="content-header">Horas disponibles</div>
                    </div>
                </div>
                        ...
                        <div class="col col-md-10 ">
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body">
                                        <!-- Datatable starts -->
                                        <a type="button" class="btn bg-light-info " href="{{url('citas/tiempo/create')}}">Crear nuevo</a>
                                        <hr>
                                                ...
                                                @foreach($available_times as $available_time)
                                                    <tr>
                                                        ...
                                                        <td class="text-truncate">
                                                            ...
                                                            -->
                                                                <a href="{{url('citas/tiempo/'. $available_time-> id . '/edit')}}" class=" btn success p-0">
