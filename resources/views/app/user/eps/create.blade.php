...
@section('content')
    ...
    <div class="main-content">
        ...
        <div class="content-wrapper"><section class="users-list-wrapper">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="content-header">Crear nueva EPS</div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form action="{{url('usuarios/eps')}}" method="POST">
                                    @csrf

                                    <div class="form-row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">
                                                <label for="basic-form-1">Nombre de la EPS</label>
                                                <input type="text" id="name" name="name" class="form-control" placeholder="Ej: Nueva eps" required>
                                            </div>
                                        </div>
                                    </div>
                                    <button type="submit" class="btn bg-light-primary mr-1 mb-1 mb-sm-0 form-crear"><i class="ft-check-square mr-1"></i>Guardar</button>
                                    <a href="{{url('usuarios/eps')}}"type="button" class="btn bg-light-secondary mr-1 mb-1 mb-sm-0"><i class="ft-x mr-1"></i>Cancelar </a>
                                </form>
                            </div>
                        </div>
                    </div>
