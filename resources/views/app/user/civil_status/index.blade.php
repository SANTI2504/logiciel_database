    ...
    <div class="main-content">
        ...
        <div class="content-wrapper">
            <section class="users-list-wrapper">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="content-header">Estado civil</div>
                    </div>
                </div>
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a type="button" class="btn bg-light-info"
                                           href="{{url('usuarios/estado-civil/create')}}">Crear nuevo</a>
                                        <hr>
                                                ...
                                                @foreach($civil_statuses as $civil_status)
                                                    <tr>
                                                        ...
                                                        <td class="text-truncate">
                                                            <form action="{{url('usuarios/estado-civil', $civil_status -> id)}}"
                                                                  method="post">
                                                            @csrf
                                                            @method('delete')
                                                            <!--
                                                            ...
                                                            -->
                                                                <a href="{{url('usuarios/estado-civil/'. $civil_status-> id . '/edit')}}"
