...
@section('content')
    ...
    <div class="main-content">
        ...
        <div class="content-wrapper"><section class="users-list-wrapper">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="content-header">Tipo de cita</div>
                    </div>
                </div>
                        ...
                        <div class="col col-md-10 ">
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body">
                                        <!-- Datatable starts -->
                                        <a type="button" class="btn bg-light-info " href="{{url('citas/tipo-cita/create')}}">Crear nuevo</a>
                                        <hr>
                                        <div class="table-responsive">
                                            <table id="users-list-datatable" class="table table-hover file-export " >
                                                ...
                                                @foreach($type_appointments as $type_appointment)
                                                    <tr>
                                                        <td>{{$type_appointment-> id}}</td>
                                                        <td>{{$type_appointment-> name}}</td>
                                                        <td class="text-truncate">
                                                            ...
                                                            -->
                                                                <a href="{{url('citas/tipo-cita/'. $type_appointment-> id . '/edit')}}" class=" btn success p-0">
