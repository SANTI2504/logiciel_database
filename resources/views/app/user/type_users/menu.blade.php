    ...
    <div class="main-content">
        ...
        <div class="content-wrapper">
            ...
            <section id="minimal-statistics">
                <div class="row">
                    <div class="col-12">
                        <div class="content-header">Menú Tipos de usuarios</div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-12">
                        <a href="{{url('usuarios/especialistas')}}">
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body text-center dark">
                                                <h3 class="mb-1 danger">Especialistas</h3>
                                                <spam>Ver Especialistas registrados</spam>
                                            </div>
                                            <div class="media-right align-self-center">
                                                <i class="ft-eye danger font-large-2 float-right"></i>
                                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-12">
                        <a href="{{url('usuarios/auxiliares')}}">
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body text-center dark">
                                                <h3 class="mb-1 danger">Auxiliares</h3>
                                                <spam>Ver Auxiliares registrados</spam>
                                            </div>
                                            <div class="media-right align-self-center">
                                                <i class="ft-eye danger font-large-2 float-right"></i>
                                            </div>
