    ...
    <div class="main-content">
        ...
        <div class="content-wrapper">
            <section class="users-list-wrapper">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="content-header">Editar Fabricante para el id {{$lab_manufacturer-> id}}</div>
                ...
                <div class="col col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{url('fabricantes', $lab_manufacturer-> id)}}" method="POST">
                                    @method('PUT')
                                    @csrf
                                    <div class="form-row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" id="name" name="name" class="form-control"
                                                       placeholder="Ej: Totto" value="{{$lab_manufacturer -> name}}"
                                                       required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <a href="{{url('fabricantes')}}" type="button"
