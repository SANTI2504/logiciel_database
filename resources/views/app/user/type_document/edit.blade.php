                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <form action="{{url('usuarios/tipo-documento', $type_document-> id)}}" method="POST">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="text" id="name" name="name" class="form-control" placeholder="Ej: Cedula de ciudadania" value="{{$type_document -> name}}" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <a href="{{url('usuarios/tipo-documento')}}"type="button" class="btn bg-light-secondary mr-1 mb-1 mb-sm-0"><i class="ft-x mr-1"></i>Cancelar </a>
                                    </form>
                                </div>
                            </div>
                        </div>
