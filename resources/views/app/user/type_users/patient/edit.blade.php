                            ...
                            <div class="form-row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <input id="name" type="text" name="name"  required autofocus autocomplete="name" class="form-control mb-2" placeholder="ej: Camilo Andres" value="{{$patient ->name}}" >
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-2">
                                        <label for="basic-form-2">Apellidos</label>
                                        <input id="lastnames" type="text" name="lastnames"  required autocomplete="lastnames" class="form-control mb-2" placeholder="ej: Mesa Rincon" value="{{$patient ->lastnames}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <input id="email" type="email" name="email" value="{{$patient -> email}}" required class="form-control mb-2" placeholder="ej: camilo@gmail.com">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-2">
                                        <label for="basic-form-4">Numero de contacto</label>
                                        <input id="number_cell" type="text" name="number_cell" value="{{$patient -> number_cell}}" required class="form-control mb-2" placeholder="ej: 3115676507">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <input id="number_document" type="text" name="number_document" value="{{$patient -> number_document}}" required class="form-control mb-2" placeholder="ej: 1023659635">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <input id="date_of_bird" type="date" name="date_of_bird" value="{{ $patient -> date_of_bird }}" required class="form-control mb-2">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-2">
